...
| **P3 · render** | bim-24 | stage 4 on both viewers, the legend, `data-pv-modules`, the e2e assertion | `reference-retrofit-visuals.tsx`, `viewer/solar-panels.tsx`, `e2e/reference-buildings.spec.ts` (the one assertion — bim-83 owns the file; coordinate) |
