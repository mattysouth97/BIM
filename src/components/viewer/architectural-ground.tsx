 ...
 * foundation plinth, paved out to the full field extent.
 *
 * Deliberately paved urban context — no grass field, no street trees. Korean
 * urban parcels read as paved ground, and the procedural trees this replaced
 * (cylinder trunk, sphere canopy) looked worse than their absence. Removing
 * them left QualityBudget.vegetation with no reader, so that flag went too.
 *
 * Visual context only — does not alter ledger dimensions.
 */
