...
const BASE_RECIPE: Omit<BuildingRecipe, "era"> = {
  ...
  materials: {
    wall: { color: "#B8B0A8", roughness: 0.8, metalness: 0 },
    glass: { color: "#88BBDD", roughness: 0.1, metalness: 0.1 },
    mullion: { color: "#808890", roughness: 0.4, metalness: 0.8 },
    slab: { color: "#B8B0A8", roughness: 0.9, metalness: 0 },
    column: { color: "#B8B0A8", roughness: 0.9, metalness: 0 },
    roof: { color: "#808080", roughness: 0.95, metalness: 0 },
