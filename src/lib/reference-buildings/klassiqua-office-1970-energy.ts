...
export const KLASSIQUA_ASSUMPTIONS = Object.freeze([
  ...
  { id: "A-SCENARIO-T1", assumes: "T1_1970: gas condensing heating with radiators, natural ventilation, no active cooling, no baseline PV.", why: "The source documentation table 3.5 (PDF page 19) defines this scenario; technical plant is not represented in the IFC. Heating efficiency 0.90 and gas DHW efficiency 0.85 are BIMFIT assumptions, not source values. Cooling efficiency zero intentionally produces no cooling electricity; this does not establish thermal comfort." },
