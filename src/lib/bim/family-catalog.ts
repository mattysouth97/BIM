...
export const AUTHORING_FAMILIES: AuthoringFamily[] = [
  ...
  fam("window-double-casement-1500x1200", "window", "Windows", "창", "Double Casement", "양여닫이창", "1500 x 1200mm", "1500 × 1200mm", "loadable", "wall", "opening-center", "hosted", "Double casement"),
  fam("window-double-hung-900x1500", "window", "Windows", "창", "Double-Hung", "오르내리창", "900 x 1500mm", "900 × 1500mm", "loadable", "wall", "opening-center", "hosted", "Double-hung"),
  fam("window-louvre-1200x1200", "window", "Windows", "창", "Louvre", "루버창", "1200 x 1200mm", "1200 × 1200mm", "loadable", "wall", "opening-center", "hosted", "Louvre"),
  fam("window-industrial-1800x900", "window", "Windows", "창", "Industrial Window", "공업용 창", "1800 x 900mm", "1800 × 900mm", "loadable", "wall", "opening-center", "hosted", "Industrial"),
