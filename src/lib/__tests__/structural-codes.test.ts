...
function makeRecipe(
  ...
  return {
    ...
    materials: {
      wall: { color: "#cccccc", roughness: 0.8, metalness: 0 },
      glass: { color: "#88aacc", roughness: 0.1, metalness: 0, transparent: true, opacity: 0.4 },
      mullion: { color: "#888888", roughness: 0.5, metalness: 0.3 },
      slab: { color: "#aaaaaa", roughness: 0.9, metalness: 0 },
      column: { color: "#999999", roughness: 0.8, metalness: 0 },
      roof: { color: "#bbbbbb", roughness: 0.9, metalness: 0 },
      groundFloor: { color: "#999999", roughness: 0.9, metalness: 0 },
    },
    siteWidth: 25,
    siteDepth: 20,
